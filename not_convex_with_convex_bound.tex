...
\newcommand{\pddder}[4]{\frac{\partial^2 #1}{\partial #2 \partial #3 \partial #4}}
\newcommand{\pdersimple}[2]{#1_{#2}}
\newcommand{\pDer}[2]{\partial_{#2}\left( #1 \right)}
...
\newcommand{\grad}{\raisebox{2pt}{$\mathop{}\!\mathbin\bigtriangledown$}\raisebox{-2pt}{$ $}}
...
\newcommand{\set}[1]{ \! \left\{ #1 \right\} }  %13.02.2015
\newcommand{\bracket}[1]{\! \left[ #1 \right] }  %13.02.2015

\newcommand{\codim}{\mathrm{codim\,}}
\renewcommand{\ker}{\mathtt{ker\,}}
\newcommand{\im}{\mathtt{im\,}}

\newcommand{\ball}[3]{\mathrm{B}_{#3}\left(#1,\, #2\right)}
\newcommand{\clball}[3]{\overline{\mathrm{B}_{#3}\left(#1,\, #2\right)}}
...
\newcommand{\parD}{\mathtt{parD}}

%\newcommand{\displaybeginfileinfo}{{\tiny \{\footnote{Beginning of the file ``\urlstyle{tt}\expandafter\nolinkurl\expandafter{\currfilename}'' \pdffilemoddate{\currfilename}}\}\/}}
%\newcommand{\displayendfileinfo}{{\tiny \{\footnote{End of the file ``\urlstyle{tt}\expandafter\nolinkurl\expandafter{\currfilename}''}\}\/}}
